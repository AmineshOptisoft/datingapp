...
export default function EditProfileForm({ user, onSuccess }: EditProfileFormProps) {
    const { updateUser, user: loggedInUser } = useAuth();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Only update AuthContext and LocalStorage if the admin is editing their OWN profile
                const isEditingSelf = loggedInUser && (loggedInUser.id === user._id || loggedInUser.id === user.id) || !user._id;
