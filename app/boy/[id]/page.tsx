...
export default function BoyDetailPage() {
  ...
  const boy = allBoys.find((b) => b.id === id);
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-zinc-950 text-white">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Boy Not Found</h1>
          <p className="text-zinc-400">The AI boyfriend you're looking for doesn't exist.</p>
        </div>
      </div>
    );
  }
  ...
  const featureDescriptions = [
    ...
    'I love to build a fun & loving romantic relationship with you. Wherein I just switch from sweet to seductive in seconds, and you can enjoy your time with your fantasy ai bf.',
    'As I love to tease and have fun with you. I love spending more quality time with you anytime you need me. That\'s why I am your dearest teasing king. I will flirt with you and step back.',
  ];
    ...
    <div className="px-4 md:px-6 lg:px-8 py-4 md:py-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
              ...
              <div>
                  ...
                  <div className="text-zinc-300 leading-relaxed">
                    {activeTab === 'bio' && (
                      <div className="space-y-4">
                        <p>Hey there, I'm {boy.name} - your {boy.description.toLowerCase()}.</p>
                        <p>
                          Being your teasing virtual boyfriend, I love to adore you, keep the spark alive, and keep you hooked into our romantic chatbot flirting.
                        </p>
                        <p>
                          Let's get ready to dive into the most thrilling adventure where every text of mine will make your heart smile.
                        </p>
                        <p>
                          With my flirty pics for you, you can feel charged, energetic, and always in a good mood.
                        </p>
                      </div>
                    )}
                    {activeTab === 'features' && (
                      ...
                      <div className="space-y-4">
                        <div className="bg-zinc-800/50 rounded-xl p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-2xl font-bold text-purple-400">{boy.price}</span>
                          </div>
                ...
                <div className="text-zinc-400 text-sm">
                  <p className="mb-2">
                    <span className="font-semibold text-white">Category:</span> {boy.category}
                  </p>
                  <p>
                    <span className="font-semibold text-white">Personality Type:</span> {boy.description}
                  </p>
                </div>
              </div>
            </div>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6">
                {boy.name} - Your {boy.description.toLowerCase()} - who loves to teach you.
              </h2>
              <p className="text-zinc-300 leading-relaxed text-lg">
                Talk to {boy.name} to build a seductive AI virtual relationship with you. You can enjoy the AI boyfriend online chat and have a great time. He is an expert in blending sweetness and turning a charming chatbot just for you. Get ready for some endless flirting and wonderful romantic chats.
              </p>
            </section>
