      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 z-10 rounded-full bg-white/90 hover:bg-white p-1.5 shadow-lg transition-all hover:scale-110 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
          >
